...
<section class="bg-red-50 section-padding">
    <div class="container-custom">
        <div class="text-center mb-12 lg:mb-16">
            ...
            <p class="text-slate-600 max-w-2xl mx-auto text-lg">Un singur agent, o singură bază de cunoștințe, toate canalele. Telefon și Web Chatbot disponibile acum. WhatsApp, Facebook și Instagram — în curând.</p>
        </div>

        <div class="grid sm:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {{-- WhatsApp --}}
            <div class="relative bg-white rounded-2xl p-8 border border-slate-200 shadow-sm hover:shadow-lg transition-shadow duration-300 opacity-75">
                <span class="absolute top-4 right-4 inline-flex items-center px-2.5 py-1 rounded-full text-[10px] font-bold uppercase tracking-wider bg-amber-100 text-amber-700 border border-amber-200">In curând</span>
