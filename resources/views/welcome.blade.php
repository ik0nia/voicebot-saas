...
<body class="bg-slate-900 text-white antialiased min-h-screen">
    ...
    <nav class="fixed top-0 w-full z-50 bg-slate-900/80 backdrop-blur-lg border-b border-slate-700/50">
        <div class="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
            <span class="text-xl font-extrabold tracking-tight">Voice<span class="text-red-400">Bot</span></span>
            <div class="flex items-center gap-4">
                ...
                @else
                    ...
                    <a href="/register" class="text-sm font-medium bg-red-800 hover:bg-red-700 px-4 py-2 rounded-lg transition">Register</a>
                @endauth
            </div>
        </div>
    </nav>
    ...
    <section class="pt-36 pb-24 px-6">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="/register" class="bg-red-800 hover:bg-red-700 text-white font-semibold px-8 py-3.5 rounded-xl transition text-lg">
                    Începe acum
                </a>
    ...
    <section id="features" class="pb-24 px-6">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <div class="p-6 rounded-2xl bg-slate-800/60 border border-slate-700/50 hover:border-red-500/40 transition">
                    <div class="w-10 h-10 rounded-lg bg-red-700/20 flex items-center justify-center mb-4 text-red-400 text-lg font-bold">🎙</div>
            ...
            <div class="grid md:grid-cols-3 gap-6">
                ...
                <div class="p-8 rounded-2xl bg-slate-800/60 border border-slate-700/50">
                    ...
                    <ul class="space-y-3 mb-8 text-sm text-slate-300">
                        <li class="flex items-center gap-2"><span class="text-red-400">✓</span> 1 bot vocal</li>
                        <li class="flex items-center gap-2"><span class="text-red-400">✓</span> 500 minute / lună</li>
                        <li class="flex items-center gap-2"><span class="text-red-400">✓</span> 2 membri echipă</li>
                        <li class="flex items-center gap-2"><span class="text-red-400">✓</span> Suport email</li>
                    </ul>
                ...
                {{-- Pro --}}
                <div class="p-8 rounded-2xl bg-red-800/10 border border-red-500/30 relative">
                    <div class="absolute -top-3 left-1/2 -translate-x-1/2 bg-red-800 text-white text-xs font-bold px-3 py-1 rounded-full">Popular</div>
                    ...
                    <a href="/register" class="block text-center py-3 rounded-xl font-semibold bg-red-800 hover:bg-red-700 text-white transition">
                        Începe acum
                    </a>
                </div>
    ...
    <footer class="border-t border-slate-700/50 py-10 px-6">
        <div class="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
            <span class="text-sm font-bold">Voice<span class="text-red-400">Bot</span></span>
