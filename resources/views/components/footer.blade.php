<footer class="bg-slate-950 text-white relative overflow-hidden">
    ...
    <div class="container-custom relative z-10">
        ...
        <div class="py-12 lg:py-16 border-b border-slate-800/50">
            <div class="flex flex-col lg:flex-row items-center justify-between gap-8">
                <div class="text-center lg:text-left">
                    ...
                    <p class="text-muted text-sm">Configurare în 10 minute. Fără card de credit. Anulare oricând.</p>
                </div>
                <div class="flex items-center gap-3">
                    <a href="/register" class="inline-flex items-center gap-2 px-7 py-3 bg-coral text-white font-bold text-sm rounded-full hover:bg-coral transition-all duration-200 shadow-lg shadow-red-900/30">
        ...
        <div class="py-12 lg:py-16">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
                ...
                <div class="lg:col-span-4">
                    ...
                    {{-- Social --}}
                    <div class="flex items-center gap-3">
                        <a href="https://linkedin.com/company/sambla-ai" class="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center text-muted hover:bg-slate-700 hover:text-white transition-all duration-200" aria-label="LinkedIn">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg>
                        </a>
                        <a href="https://x.com/sambla_ai" class="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center text-muted hover:bg-slate-700 hover:text-white transition-all duration-200" aria-label="X/Twitter">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                        </a>
                        <a href="https://facebook.com/sambla.ai" class="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center text-muted hover:bg-slate-700 hover:text-white transition-all duration-200" aria-label="Facebook">
                ...
                <div class="lg:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-8">
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li><a href="/functionalitati" class="text-sm text-muted hover:text-white transition-colors">Funcționalități</a></li>
                            <li><a href="/preturi" class="text-sm text-muted hover:text-white transition-colors">Prețuri</a></li>
                            <li><a href="#demo" class="text-sm text-muted hover:text-white transition-colors">Demo live</a></li>
                            <li><a href="/register" class="text-sm text-muted hover:text-white transition-colors">Înregistrare</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="text-xs font-bold text-white uppercase tracking-widest mb-5">Companie</h4>
                        <ul class="space-y-3">
                            <li><a href="/despre" class="text-sm text-muted hover:text-white transition-colors">Despre noi</a></li>
                            <li><a href="/contact" class="text-sm text-muted hover:text-white transition-colors">Contact</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="text-xs font-bold text-white uppercase tracking-widest mb-5">Legal</h4>
                        <ul class="space-y-3">
                            <li><a href="/termeni" class="text-sm text-muted hover:text-white transition-colors">Termeni</a></li>
                            <li><a href="/confidentialitate" class="text-sm text-muted hover:text-white transition-colors">Confidențialitate</a></li>
                            <li><a href="/cookie-uri" class="text-sm text-muted hover:text-white transition-colors">Cookie-uri</a></li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li>
                                <a href="mailto:servus@sambla.ro" class="text-sm text-muted hover:text-white transition-colors flex items-center gap-2">
                                    <svg class="w-4 h-4 shrink-0 text-muted" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75"/></svg>
                                    servus@sambla.ro
                                </a>
                            </li>
                            <li>
                                <a href="tel:+40775222333" class="text-sm text-muted hover:text-white transition-colors flex items-center gap-2">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-between gap-4 py-6 border-t border-slate-800/50">
            <p class="text-xs text-muted">&copy; {{ date('Y') }} Sambla. Toate drepturile rezervate.</p>
            ...
            <p class="text-xs text-muted">Făcut cu <span class="text-coral">❤️</span> în România</p>
        </div>
    </div>
</footer>
