    ...
    <div class="container-custom py-24 lg:py-32 relative z-10">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                <a href="{{ $primaryHref }}" class="group inline-flex items-center gap-2.5 px-10 py-4 rounded-full bg-white text-coralh font-bold hover:bg-coralsoft transition-all duration-300 shadow-xl shadow-black/10 text-base hover:scale-105">
                    {{ $primaryText }}
