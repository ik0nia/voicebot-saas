    ...
    <div class="lg:col-span-1 space-y-4">
        ...
        <div class="bg-white rounded-xl border border-line p-5">
            ...
            <dl class="space-y-2 text-sm">
                ...
                <div><dt class="text-muted text-xs">Scor</dt><dd class="font-bold text-lg {{ $lead->qualification_score >= 60 ? 'text-emerald-600' : 'text-amber-600' }}">{{ $lead->qualification_score }}/100</dd></div>
