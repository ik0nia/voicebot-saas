    <div id="prompt-modal" class="hidden fixed inset-0 z-50 flex items-center justify-center bg-black/50">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[80vh] flex flex-col mx-4">
            <div class="px-6 py-4 border-b flex items-center justify-between">
                <h3 class="text-lg font-semibold text-ink">Editeaza Prompt Sistem</h3>
            ...
            <div class="px-6 py-4 border-t flex justify-end gap-3">
                ...
                <button onclick="savePrompt()" class="px-4 py-2 text-sm font-medium rounded-lg bg-coral text-white hover:bg-coralh transition-colors">Salveaza</button>
            </div>
        </div>
    </div>