...
@section('content')
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-muted mt-1">
            Canalul WhatsApp <span class="font-medium text-inkSoft">{{ $channel->name }}</span> e creat și criptat. Acum spune-i lui Meta unde să livreze mesajele tale.
        </p>
    </div>
        ...
        <div class="rounded-xl border border-line bg-white p-6 shadow-sm">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-muted mt-0.5 mb-3">În Meta Developer Console → App-ul tău → WhatsApp → Configuration → Webhook → Edit.</p>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <ul class="space-y-1 text-sm text-inkSoft">
                        <li>• <code class="bg-cream px-1.5 py-0.5 rounded text-xs">messages</code> &mdash; mesajele primite</li>
                        <li>• <code class="bg-cream px-1.5 py-0.5 rounded text-xs">message_template_status_update</code> &mdash; statusul template-urilor</li>
                    </ul>
                </div>
            </div>
        </div>
