        ...
        <aside class="space-y-4">
            <div class="rounded-xl border border-slate-200 bg-slate-50 p-5">
                ...
                <ol class="space-y-2.5 text-xs text-slate-600 list-decimal list-inside">
                    ...
                    <li>Trimiți un mesaj test către pagina ta și agentul răspunde.</li>
                </ol>
            </div>

            <div class="rounded-xl border border-amber-200 bg-amber-50 p-5">
                <h3 class="text-sm font-semibold text-amber-900 mb-2">N-ai încă acces la pages_messaging?</h3>
                <p class="text-xs text-amber-800 leading-relaxed">
                    Meta App-ul tău trebuie să aibă App Review aprobat pentru permisiunile <code class="text-[11px] bg-amber-100 px-1 rounded">pages_messaging</code> + <code class="text-[11px] bg-amber-100 px-1 rounded">pages_show_list</code>. Procedura durează 3-7 zile la prima trimitere. Vezi
                    <a href="https://developers.facebook.com/docs/messenger-platform/getting-started" target="_blank" class="underline font-medium">documentația Meta</a>.
                </p>
            </div>
        </aside>
    </div>
