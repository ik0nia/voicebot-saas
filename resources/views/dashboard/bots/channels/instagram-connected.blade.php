...
@section('content')
    ...
    <div class="mb-6">
        ...
        <p class="text-sm text-slate-500 mt-1">
            Canalul Instagram DM <span class="font-medium text-slate-700">{{ $channel->name }}</span> e creat și criptat. Acum spune-i lui Meta unde să livreze mesajele directe.
        </p>
    </div>
        ...
        <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-slate-500 mt-0.5 mb-3">În Meta Developer Console → App-ul tău → Instagram → Webhooks → Add Callback URL.</p>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <ul class="space-y-1 text-sm text-slate-700">
                        <li>• <code class="bg-slate-100 px-1.5 py-0.5 rounded text-xs">messages</code> &mdash; mesajele primite în DM</li>
