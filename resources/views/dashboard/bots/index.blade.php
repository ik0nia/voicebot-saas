...
@section('content')
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            <h1 class="text-2xl font-bold text-ink">Agenți AI</h1>
            <p class="mt-1 text-sm text-muted">Gestionează asistenții vocali ai organizației tale.</p>
        </div>
    ...
    @else
        ...
        <div class="flex flex-col items-center justify-center py-16 px-4">
            ...
            <h3 class="text-lg font-semibold text-ink mb-1">Nu ai niciun agent AI încă</h3>
            <p class="text-sm text-muted mb-6 text-center max-w-sm">Creează primul tău agent AI pentru a începe să automatizezi apelurile telefonice.</p>
            <a href="{{ route('dashboard.bots.create') }}"
