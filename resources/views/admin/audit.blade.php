                ...
                <div class="divide-y divide-slate-100">
                    @php
                        $highs = [
                            ...
                            ['Race condition: duplicate calls pe webhook retry', 'TwilioWebhookController', 'Twilio poate trimite webhook-ul de mai multe ori. Nu se verifică dacă call-ul există deja.'],
                            ['Missing status callback events', 'TwilioService', 'Lipsesc busy, no-answer, canceled, failed din statusCallbackEvent array.'],
                ...
                <div class="divide-y divide-slate-100">
                    @php
                        $mediums = [
                            ...
                            ['Hardcoded call costs (20¢/min)', 'TwilioWebhookController', 'Cost fix fără legătură cu costurile reale Twilio/OpenAI. Nicio configurabilitate.'],
