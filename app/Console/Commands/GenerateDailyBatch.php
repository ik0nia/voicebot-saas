...
class GenerateDailyBatch extends Command
{
    ...
    private function storyPrompt(array $topicData): string
    {
        ...
        return "Create a 9:16 vertical Instagram STORY graphic for Sambla (Romanian AI chat & voice bot platform). "
            ...
            . "PEOPLE RULE — STRICT: if the scene includes any humans, they MUST be Caucasian / European-looking only (light to medium skin tone, European facial features). NO Black, NO Asian, NO South Asian, NO Middle Eastern, NO 'diverse team' compositions. Single European person preferred. Audience is Romanian SMB owners. "
